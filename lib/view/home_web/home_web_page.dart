...
import 'home_web_cubit.dart';

class HomeWebArguments {

  HomeWebArguments();
}

class HomeWebPage extends StatelessWidget {
  final HomeWebArguments arguments;
...
class HomeWebChildPage extends StatefulWidget {
  final HomeWebArguments arguments;

  const HomeWebChildPage({
    required this.arguments,
    Key? key,
  }) : super(key: key);

  @override
  State<HomeWebChildPage> createState() => _HomeWebChildPageState();
}

class _HomeWebChildPageState extends State<HomeWebChildPage> {
  late final HomeWebCubit _cubit;
  ...
  Widget _buildBodyWidget() {
    return BlocBuilder<HomeWebCubit, HomeWebState>(
