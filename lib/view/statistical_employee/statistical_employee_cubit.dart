...
part 'statistical_employee_state.dart';

class StatisticalEmployeeCubit extends Cubit<StatisticalEmployeeState> {

  StatisticalEmployeeCubit() : super(const StatisticalEmployeeState());
